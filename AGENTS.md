...
Issues and tasks are tracked with Ordna in `tasks/*.md`, using the `ordna` CLI. See `docs/agents/issue-tracker.md`.

### Triage labels

Triage roles are represented as Ordna tags with the default label vocabulary. See `docs/agents/triage-labels.md`.
