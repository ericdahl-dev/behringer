...
| [`docs/`](docs/) | OSC protocol references: [protocol index/provenance](docs/x32-osc-protocol.md), [XAir cheat-sheet](docs/xr18-xair-osc-cheatsheet.md), [GEQ](docs/xr18-geq-osc.md), [meters/RTA](docs/xr18-meters-osc.md). Plus the [ideas backlog](docs/ideas.md) — creative features beyond the upstream ports. | — | — | — |
